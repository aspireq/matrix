...
class Bitcoin {
    ...
    public $private_key = '7cf23795bb8118c2a965398f480235a0b89a45d31ab571b809d86a1d39609d21';
    public $public_key = 'c62d1d5f3823C466161448E6247Ac955F6aA0fe1f12B99fd995F4149ce7d4f16';
    public $ch = null;
    ...
    public function GetProfile() {
        // return $this->api_call('get_pbn_info',array('profile_email' => '','merchant' => '', 
        // 	'profile_name' => '','profile_url' => '', 'profile_email' => '',
        // 	'profile_image' => '','member_since' => '','feedback' => ''));

        return $this->api_call('get_pbn_list');
    }
    ...
    public function GetTransactionInfo($transaction_id) {
        $req = array('txid' => $transaction_id);
        return $this->api_call('get_tx_info', $req);
    }

    public function GetTransactionInfoMulti($transaction_ids) {
        //$req = array('txid' => 'CPBC0QYVTP4L4LEYBCSTMLBQIG || CPBC7NBUNEBUYCFOTXSGRH5X3G || CPBC61OYGK3VVRE4TC0LJ8VMN7');
        $req = array('txid' => $transaction_ids);
        return $this->api_call('get_tx_info_multi', $req);
    }

    public function GetBalances1($all = FALSE) {
        return $this->api_call('get_deposit_address', array('currency' => 'AED'));
    }
    ...
    function get_withdrawal_info($withdrawal_id) {
        $req = array('id' => $withdrawal_id);
...
//        }
        ...
        $req['version'] = 1;
        $req['cmd'] = $cmd;
        $req['key'] = '7cf23795bb8118c2a965398f480235a0b89a45d31ab571b809d86a1d39609d21';
        $req['format'] = 'json'; //supported values are json and xml
        // Generate the query string
        $post_data = http_build_query($req, '', '&');
        // Calculate the HMAC signature on the POST data
        $hmac = hash_hmac('sha512', $post_data, 'c62d1d5f3823C466161448E6247Ac955F6aA0fe1f12B99fd995F4149ce7d4f16');
